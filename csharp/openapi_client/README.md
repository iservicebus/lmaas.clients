...
## Documentation for Models
 ...
 - [Model.ChatCompletionReq](docs/ChatCompletionReq.md)
 - [Model.ChatText](docs/ChatText.md)
 - [Model.ChatTextList](docs/ChatTextList.md)
 - [Model.HTTPValidationError](docs/HTTPValidationError.md)
 - [Model.MaxTokens](docs/MaxTokens.md)
