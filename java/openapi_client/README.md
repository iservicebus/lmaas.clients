...
FastAPI
- API version: 0.1.0
  - Build date: 2024-02-18T22:37:19.055682-05:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**chatCompletionChatCompletionPost**](docs/DefaultApi.md#chatCompletionChatCompletionPost) | **POST** /chat/completion | Chat Completion
